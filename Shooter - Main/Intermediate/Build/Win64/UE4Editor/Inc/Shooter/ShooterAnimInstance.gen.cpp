...
// End Cross Module References
	DEFINE_FUNCTION(UShooterAnimInstance::execUpdateAnimationPorperties)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_DelatTime);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateAnimationPorperties(Z_Param_DelatTime);
		P_NATIVE_END;
	}
	void UShooterAnimInstance::StaticRegisterNativesUShooterAnimInstance()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "UpdateAnimationPorperties", &UShooterAnimInstance::execUpdateAnimationPorperties },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics
	{
		struct ShooterAnimInstance_eventUpdateAnimationPorperties_Parms
		{
			float DelatTime;
		};
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DelatTime;
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::NewProp_DelatTime = { "DelatTime", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ShooterAnimInstance_eventUpdateAnimationPorperties_Parms, DelatTime), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::NewProp_DelatTime,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "ShooterAnimInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UShooterAnimInstance, nullptr, "UpdateAnimationPorperties", nullptr, nullptr, sizeof(ShooterAnimInstance_eventUpdateAnimationPorperties_Parms), Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UShooterAnimInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UShooterAnimInstance_UpdateAnimationPorperties, "UpdateAnimationPorperties" }, // 3704860780
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UShooterAnimInstance_Statics::NewProp_bIsAccelerating_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Movement" },
		{ "Comment", "/* Whether the character is moving*/" },
		{ "ModuleRelativePath", "ShooterAnimInstance.h" },
		{ "ToolTip", "Whether the character is moving" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UShooterAnimInstance_Statics::NewProp_MovementOffsetYaw_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Movement" },
		{ "Comment", "/* Offset yaw used for straffing */" },
		{ "ModuleRelativePath", "ShooterAnimInstance.h" },
		{ "ToolTip", "Offset yaw used for straffing" },
	};
#endif
	...
	IMPLEMENT_CLASS(UShooterAnimInstance, 236698383);
